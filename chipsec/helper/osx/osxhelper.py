...
from chipsec.file import TOOLS_DIR, get_main_dir
...
LZMA  = os.path.join(TOOLS_DIR,"compression","bin","LzmaCompress")
TIANO = os.path.join(TOOLS_DIR,"compression","bin","TianoCompress")
EFI   = os.path.join(TOOLS_DIR,"compression","bin","TianoCompress")
BROTLI = os.path.join(TOOLS_DIR,"compression","bin","Brotli")
...
class OSXHelper(Helper):
    ...
    def load_driver(self):
        driver_path = os.path.join(get_main_dir(), "chipsec",
